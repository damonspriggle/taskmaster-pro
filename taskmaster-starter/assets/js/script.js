...
$(".list-group").on("change", "span", function() {
  // get current text 
...
$(this).replaceWith(dateInput);
  ...
  dateInput.datepicker({
    minDate: 1,
    onClose: function() {
      // when calancer is closed, force a "change" event on the 'dateInput'
      $(this).trigger("change");
    }
  });

  // auto bring up calander
...
var auditTask = function(taskE1) {
  ...
  else if (Math.abs(moment().diff(time, "dats")) <= 2) {
